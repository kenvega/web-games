...
export const SYMBOL_MATCH_SYMBOL_CATALOG = {
  ...
  train: defineSymbol("train", "Passenger train"),
  ...
  "test-tube": defineSymbol("test-tube", "Test tube"),
  wand: defineSymbol("wand", "Magic wand"),
  "money-bag": defineSymbol("money-bag", "Money bag"),
  ...
  cyclone: defineSymbol("cyclone", "Cyclone"),
